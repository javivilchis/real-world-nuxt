...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <p>A real world events applications done in NUXT using VUE JS/VUEX, Visit the github for all code content.</p>
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/javivilchis/real-world-nuxt" target="_blank"><svg
        ...
        <a href="https://twitter.com/javivilchis" target="_blank"><svg
          class="w-6 h-6 text-gray-600 hover:text-gray-800"
          xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink"
          aria-hidden="true"
